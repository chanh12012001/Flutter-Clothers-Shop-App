...
import 'package:grocery_app_flutter/widgets/search_card.dart';
  ...
  void initState() {
    FirebaseFirestore.instance.collection('products').get().then((QuerySnapshot querySnapshot) {
      querySnapshot.docs.forEach((doc) {
        setState(() {
          document = doc;
          offer = ((doc.data()['comparedPrice'] - doc.data()['price']) / doc.data()['comparedPrice'] * 100).toStringAsFixed(0);
  ...
  Widget build(BuildContext context) {
    ...
    mapLauncher() async {
      ...
      await availableMaps.first.showMarker(
        ...
        title: '${_store.storedetails['shopName']} ở đây',
      );
    }
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Text(
                          'Khoảng cách: ${_store.distance}km',
                          style: TextStyle(color: Colors.white),
                        ),
                        SizedBox(
                          height: 6,
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  launch('Gọi:${_store.storedetails['mobile']}');
                                },
                              ),
                            ),
                            SizedBox(
          ...
          onPressed: () {
            ...
            showSearch(
              ...
              delegate: SearchPage<Product>(
                ...
                suggestion: Center(
                  child: Text('Lọc sản phẩm theo tên, danh mục hoặc giá cả'),
                ),
                failure: Center(
