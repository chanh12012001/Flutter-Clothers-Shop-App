...
class BestSellingProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  FutureBuilder<QuerySnapshot>(
      future: _services.products.where('published',isEqualTo: true).where('collection',isEqualTo: 'Bán chạy nhất').where('seller.sellerUid',isEqualTo: _store.storedetails['uid']).limit(10).get(),
