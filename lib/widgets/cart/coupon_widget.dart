              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Vui lòng nhập mã giảm giá',
                ...
                AbsorbPointer(
                  ...
                  child: OutlineButton(
                    ...
                    onPressed: () {
                      EasyLoading.show(status: 'Phiếu giảm giá xác thực..');
                      _coupon.getCouponDetails(_couponText.text, widget.couponVendor,).then((value) {
                        if (_coupon.document == null) {
                          ...
                          EasyLoading.dismiss();
                          showDialog(_couponText.text, 'Không hợp lệ');
                          return;
                        }
                        ...
                        if(_coupon.expired==true){
                          ...
                          EasyLoading.dismiss();
                          showDialog(_couponText.text, 'Đã hết hạn');
                        }
                      });
                    },
                    child: Text(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('${_coupon.document.data()['discountRate']}% chiết khấu trên tổng số tiền mua hàng'),
                            SizedBox(
                              height: 10,
                            )
                          ],
    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
            title: Text('ÁP DỤNG MÃ GIẢM'),
            content: Text(
                'Mã giảm giá $code không hợp lệ $validity. Vui lòng thử mã khác'),
            actions: [
              FlatButton(
                child: Text(
                  'OK',
