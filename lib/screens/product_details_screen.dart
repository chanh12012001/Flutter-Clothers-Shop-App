...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var offer = ((document.data()['comparedPrice'] - document.data()['price']) / document.data()['comparedPrice']) * 100;
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Mã sản phẩm :  ${document.data()['sku']}',
                    style: TextStyle(color: Colors.grey),
                  ),
                  Text(
                    'Người bán : ${document.data()['seller']['shopName']}',
                    style: TextStyle(color: Colors.grey),
                  ),
                ],
              ),
