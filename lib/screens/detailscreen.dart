  ...
  Widget _buildDiscription() {
    return Container(
      ...
      child: Wrap(
        children: <Widget>[
          Text(
            "Với chất liệu thun cực mát, thấm hút tốt, sản phẩm sẽ mang đến cho bạn cảm giác dễ chịu và thoải mái những lúc nghỉ ngơi, thư giãn tại nhà.và những lúc bạn đi chơi,đi dạo,đi shoppinh.vvvv\n- Kiểu dáng xinh xắn với áo cổ tròn, tay lỡ họa tiết vô cùng đáng yêu, giúp bạn gái thêm tự tin với vẻ ngoài gọn gàng, dễ thương của mình.\n- Ngoài ra, trang phục còn ghi điểm bởi các họa tiết vô cùng kute, màu sắc tươi tắn, phù hợp với những cô nàng bánh bèo, đáng yêu.-\n Sản phẩm thích hợp mặc nhà, mặc đi ngủ.đi chơi,shopping,vvv ",
