  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Cửa hàng tạp hóa',style: TextStyle(color: Colors.white,),),
      ),
                    ...
                    child: Column(
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    '${userDetails.snapshot.data()['firstName']} ${userDetails.snapshot.data()['lastName']}' : 'Cập nhật tên của bạn' ,
                                    style: TextStyle(
                                  ...
                                  Text( '${userDetails.snapshot.data()['email']}' ,
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: Colors.white,
                                    ),
                        ...
                        ListTile(
                          ...
                          title: Text( userDetails.snapshot.data()['location']),
                          subtitle: Text(userDetails.snapshot.data()['address'],maxLines: 1,),
                          trailing: SizedBox(
                            width: 100,
                            child: OutlineButton(
                              borderSide: BorderSide(color: Colors.redAccent),
                              child: Text('Thay đổi',style: TextStyle(color: Colors.redAccent),),
                              onPressed: (){
